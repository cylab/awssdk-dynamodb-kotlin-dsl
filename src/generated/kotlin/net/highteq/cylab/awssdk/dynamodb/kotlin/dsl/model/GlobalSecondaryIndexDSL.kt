...
/**
  ...
  * Represents the properties of a global secondary index.
  */
inline fun globalSecondaryIndex(dslBlock: GlobalSecondaryIndexDSL.() -> Unit) =
...
/**
  ...
  * Represents the properties of a global secondary index.
  */
inline fun DynamodbDSL.Companion.globalSecondaryIndex(dslBlock: GlobalSecondaryIndexDSL.() -> Unit) =
  GlobalSecondaryIndexDSL(GlobalSecondaryIndex.builder()).apply(dslBlock).build()