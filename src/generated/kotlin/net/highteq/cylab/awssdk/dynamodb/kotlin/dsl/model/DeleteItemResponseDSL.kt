...
/**
  ...
  * Represents the output of a DeleteItem operation.
  */
inline fun deleteItemResponse(dslBlock: DeleteItemResponseDSL.() -> Unit) =
...
/**
  ...
  * Represents the output of a DeleteItem operation.
  */
inline fun DynamodbDSL.Companion.deleteItemResponse(dslBlock: DeleteItemResponseDSL.() -> Unit) =
  DeleteItemResponseDSL(DeleteItemResponse.builder()).apply(dslBlock).build()