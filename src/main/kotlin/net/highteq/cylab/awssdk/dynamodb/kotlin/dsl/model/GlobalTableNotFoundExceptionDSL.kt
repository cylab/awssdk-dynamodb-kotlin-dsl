...
/**
  ...
  */
@DynamodbDSL
class GlobalTableNotFoundExceptionDSL {
  @Deprecated("Usage of the builder field is not recommended. It might vanish in any new release!", level = WARNING)
  internal val builder = GlobalTableNotFoundException.builder()
  internal fun build(): GlobalTableNotFoundException = builder.build()
...
/**
  ...
  * The specified global table does not exist.
  */
fun buildGlobalTableNotFoundException(dslBlock: GlobalTableNotFoundExceptionDSL.() -> Unit) =
  GlobalTableNotFoundExceptionDSL().apply(dslBlock).build()