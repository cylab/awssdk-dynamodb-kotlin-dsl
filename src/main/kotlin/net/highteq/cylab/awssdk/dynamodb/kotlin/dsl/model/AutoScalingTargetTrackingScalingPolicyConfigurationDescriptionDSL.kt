...
class AutoScalingTargetTrackingScalingPolicyConfigurationDescriptionDSL {
  private val builder = AutoScalingTargetTrackingScalingPolicyConfigurationDescription.builder()
...
/**
  ...
  * Represents the properties of a target tracking scaling policy.
  */
fun buildAutoScalingTargetTrackingScalingPolicyConfigurationDescription(dslBlock: AutoScalingTargetTrackingScalingPolicyConfigurationDescriptionDSL.() -> Unit) =
  AutoScalingTargetTrackingScalingPolicyConfigurationDescriptionDSL().apply(dslBlock).build()