...
/**
  ...
  */
@DynamodbDSL
class GlobalTableAlreadyExistsExceptionDSL {
  @Deprecated("Usage of the builder field is not recommended. It might vanish in any new release!", level = WARNING)
  internal val builder = GlobalTableAlreadyExistsException.builder()
...
/**
  ...
  * The specified global table already exists.
  */
fun buildGlobalTableAlreadyExistsException(dslBlock: GlobalTableAlreadyExistsExceptionDSL.() -> Unit) =
  GlobalTableAlreadyExistsExceptionDSL().apply(dslBlock).build()